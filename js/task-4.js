...
const getTotalBalanceByGender = (users, gender) => users.filter(user => user.gender === gender).reduce((previousValue, currentValue) => (previousValue + currentValue.balance), 0);
